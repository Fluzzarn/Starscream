...
//////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    public class TCPTransport: Transport {
        ...
        private let queue = DispatchQueue(
            label: "com.vluxe.starscream.networkstream", attributes: [])
        ...
        public func connect(
            ...
            let conn = NWConnection(
                ...
                port: NWEndpoint.Port(rawValue: UInt16(parts.port))!, using: parameters)
            connection = conn
            start()
        }
        ...
        private func readLoop() {
            ...
            connection?.receive(
                minimumIncompleteLength: 2, maximumLength: 4096,
